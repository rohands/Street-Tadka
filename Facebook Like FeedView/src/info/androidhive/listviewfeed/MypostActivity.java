...
public class MypostActivity extends Activity {
	...
	private FeedListAdapter6 listAdapter;
	private List<FeedItem6> feedItems;
	private String URL_FEED = "http://streettadka.comze.com/mypost.php";
	InputStream is=null;
	String result=null;
	String line=null;
...
////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		feedItems = new ArrayList<FeedItem6>();

		listAdapter = new FeedListAdapter6(this, feedItems);
