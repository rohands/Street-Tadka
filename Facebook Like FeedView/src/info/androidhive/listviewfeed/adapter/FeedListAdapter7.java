...
public class FeedListAdapter7 extends BaseAdapter {	
	private Activity activity;
	private LayoutInflater inflater;
	private List<FeedItem7> feedItems;
	ImageLoader imageLoader = AppController.getInstance().getImageLoader();

	public FeedListAdapter7(Activity activity, List<FeedItem7> feedItems) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null)
			convertView = inflater.inflate(R.layout.whatshot, null);
		...
		FeedItem7 item = feedItems.get(position);
